  ...
  return (
    <div>
      <div className="mt-[-110px]">
        <div className="h-24 w-[1047px] ml-[228px] bg-white rounded-xl">
          <div className="flex items-center justify-center ml-14">
              ...
              <div className="flex flex-col mt-9">
                <div className="ml-[205px]">
                  <p className="text-[16px] flex items-center justify-center ml-[-288px] mt-[-18px] gap-3 text-black font-bold">
                    Job Bootcamp <br />
                    <span className="text-sm text-black rounded-e-full h-7 w-36 text-center flex items-center justify-center bg-blue-100 px-3">
                      For professionals
                    </span>
                  </p>
                </div>
                <h1 className="text-[13px] items-start ml-[-70px] mt-2">
                  Placement assistance, live+ & blended learning
                </h1>
              </div>
            ...
            <div className="flex items-center justify-center gap-5 ml-4">
              <div className="flex flex-col mt-9">
                ...
                <h1 className="text-[13px] items-start  mt-2">
                  Programs in collaboration with IIT Guwahati
                </h1>
              </div>
