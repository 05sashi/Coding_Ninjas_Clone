    ...
    <div className="h-[700px] w-screen bg-[#2d231e] ">
      <div className="flex flex-col items-center">
        <div className="flex flex-row items-start justify-between gap-14  px-80">
          <div className="flex flex-col mt-28">
            <img src="/icons/logo2.svg" className="h-7 ml-[-60px]" alt="" />
            <span className="text-sm font-bold text-white mt-10">
              Contact us
            </span>
            <div className="flex flex-row gap-4 mt-5">
              <img src="/icons/phone.svg" alt="" />
              <h1 className="text-xl text-gray-500 hover:text-gray-700 cursor-pointer">
                1800-123-3598
              </h1>
            </div>
            ...
            <div className="flex flex-row gap-4 mt-5">
              <img src="/icons/logo3.svg" className="h-9" alt="" />
            </div>

            <div className="flex flex-row gap-4 mt-6">
              <img src="/icons/logo4.webp" className="h-7" alt="" />
            </div>
          </div>
      ...
      <div className="flex items-center justify-between px-[335px] mt-8">
        ...
        <div className="flex gap-4">
          ...
          <img src="/icons/facb.svg" alt="" />
          <img src="/icons/linkd.svg" alt="" />
          <img src="/icons/twit.svg" alt="" />
          <img src="/icons/ytub.svg" alt="" />
        </div>
      </div>
    </div>
  );
