  ...
  return (
    <>
      ...
      <div className="dot-pattern">
        <div className="flex flex-col items-center p-2 md:p-0 h-screen relative">
          <h1
            className="text-3xl mt-28 py-4 text-center"
            style={{
          ...
          <video
            className="w-full max-w-[995px] rounded-lg mt-32"
            autoPlay
            muted
            loop
          >
        ...
        <div className="bg-slate-50">
          <div className="mt-6 max-w-3xl w-full flex items-start bg-slate-50">
            <img
              src="/icons/bootcampicon.svg"
              className="px-[204px] mt-[-45px]"
              alt=""
            />

            <p className="text-xl flex items-center justify-center ml-[-226px] mt-[-18px] gap-3 text-black font-bold bg-slate-50">
              Job Bootcamp <br />
              <span className="text-sm text-black rounded-e-full h-7 w-32 text-center flex items-center justify-center bg-blue-200">
                For graduates
              </span>
            </p>
          </div>
        ...
        <div className="bg-[#f8f8ef] h-[1231px]">
          ...
          <div className="mt-6 max-w-3xl w-full flex items-start">
            ...
            <p className="text-xl flex flex-col items-start ml-[-226px] mt-[-18px] gap-9 text-black font-bold">
              ...
              <span className="text-sm text-[#f8916c] rounded-full h-8 w-32 flex items-center justify-center bg-[#745e39]">
                For graduates
              </span>
            </p>
          </div>
          ...
          <div className="flex">
            <button className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-72 mt-5">
              <div className="bg-slate-100 flex flex-col items-center h-80 gap-2">
                <div className="bg-slate-100">
                  <img src="/icons/iitimage.png" alt="" className="mt-2 p-3" />
                </div>

                <div className="bg-white ml-[-199px] mt-[-41px] h-9 w-9 rounded-md">
                  <img src="/icons/frame.svg" className="mt-1 ml-1" alt="" />
                </div>

                <h3 className="text-lg font-bold text-start ml-4 p-2">
                  PG Certification in Data Analytics with GenAI
                </h3>
                <span className="text-sm text-[#4f4642] rounded-e-full h-8 w-52 ml-[-29px] flex items-center justify-center bg-[#f8f7f5]">
              ...
              <div className="bg-slate-100 p-5 flex flex-row gap-6">
                <div className="flex justify-between">
                  <div className="flex gap-2">
                    ...
                    <img src="/icons/meta.svg" alt="" />
                    <img src="/icons/meta1.svg" alt="" />
                  </div>
                  <div className="ml-14">
            ...
            <button className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-8 mt-5">
              <div className="bg-slate-100 flex flex-col items-center h-80 gap-2  ">
                ...
                <div className="bg-white ml-[-199px] mt-[-41px] h-9 w-9 rounded-md ">
                  <img
                    src="/icons/frame1.webp"
                    className=" rounded-md"
                    alt=""
                  />
                </div>

                <h3 className="text-lg text-start ml-3 font-bold  p-3">
                  PG Certification in Full Stack Web Development with Generative
                  AI
                </h3>
                <span className="text-sm text-[#4f4642] rounded-e-full h-8 w-32 ml-[-122px] flex items-center justify-center bg-[#f8f7f5]">
                  IITM Pravartak
                </span>
              </div>
              ...
              <div className="bg-slate-100 p-5 flex  flex-row gap-6">
                <div className="flex  justify-between">
                  <div className="flex gap-2">
                    <img src="/icons/meta3.png" className="h-6 w-6" alt="" />
                    <img src="/icons/meta4.png" className="h-6 w-6" alt="" />
                    <img src="/icons/meta5.png" className="h-6 w-6" alt="" />
                    <img src="/icons/meta6.png" className="h-6 w-6" alt="" />
                  </div>
                  <div className="ml-14">
          ...
          <span className="text-sm font-bold text-[#f8916c] rounded-full h-6 w-40 flex items-center justify-center bg-[#745e39] ml-72 mt-9">
          ...
          <div className="flex">
            <button className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-72 mt-5">
              <div className="bg-slate-100 flex flex-col items-center h-80 gap-2  ">
                ...
                <h3 className="text-lg font-bold text-start ml-2  p-3">
            ...
            <button className="w-72 h-[380px] rounded-lg overflow-hidden shadow-lg border border-[#e0c7bc] ml-8 mt-5">
              <div className="bg-slate-100 flex flex-col items-center h-80 gap-2  ">
                ...
                <span className="text-sm text-[#4f4642] rounded-e-full h-8 w-52 ml-[-22px] flex items-center justify-center bg-[#f8f7f5]">
                  E&ICT Academy, IIT Guwahati
                </span>
              </div>
              ...
              <div className="bg-slate-100 p-5 flex  flex-row gap-6">
                <div className="flex  justify-between">
                  <div className="flex gap-2">
                    <img src="/icons/meta2.png" className="h-6 w-6" alt="" />
                    <img src="/icons/meta7.png" className="h-6 w-6" alt="" />
                    <img src="/icons/meta8.png" className="h-6 w-6" alt="" />
                    <img src="/icons/meta1.svg" className="h-6 w-6" alt="" />
                  </div>
                  <div className="ml-14">
                    <p className="text-gray-700 text-sm">6 months</p>
                  </div>
